...
export default function RedirectPage() {
  ...
  if (status === 'preview') {
    return (
      <Layout>
        <section className="surface w-[calc(100%-32px)] max-w-xl mx-auto mt-12 md:mt-20 p-7 md:p-9">
          ...
          <p className="text-[#9db3ff] text-2xl font-bold break-all mt-2 p-4 bg-[#0d1118] border border-[#303744] rounded-md">{destination.host}</p>
          ...
          <div className="flex gap-3 mt-6">
            <button onClick={continueToDestination} className="flex-1 bg-[#4d78ff] hover:bg-[#668bff] p-3 rounded-md font-bold">Continuar</button>
